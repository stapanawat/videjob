  ...
  <div class="min-h-screen pt-24 pb-12 flex items-center justify-center px-6">
    <div class="relative z-10 w-full max-w-md bg-white dark:bg-surface-800 rounded-2xl shadow-xl border border-surface-200 dark:border-surface-700 p-8 space-y-8">
      ...
      <div class="text-center space-y-2">
        ...
        <p class="text-surface-500 dark:text-surface-400">Sign in to manage your job applications</p>
      </div>
      ...
      <div class="relative flex items-center justify-center">
        ...
        <span class="relative bg-white dark:bg-surface-800 px-4 text-sm text-surface-500 dark:text-surface-400">Or continue with</span>
      </div>

      <!-- Form -->
      <form @submit.prevent="handleLogin" class="space-y-4">
        <div class="space-y-1">
          <label class="text-sm font-medium text-surface-700 dark:text-surface-300">Email or Username</label>
          <div class="relative">
            <Icon name="lucide:user" class="absolute left-3 top-1/2 -translate-y-1/2 text-surface-400 w-5 h-5" />
            <input type="text" required class="w-full bg-surface-50 dark:bg-surface-900 border-surface-200 dark:border-surface-700 rounded-xl pl-10 pr-4 py-3 text-surface-900 dark:text-white focus:border-primary-500 focus:outline-none placeholder:text-surface-400" placeholder="Username or name@example.com">
          </div>
        </div>
        ...
        <div class="space-y-1">
           <div class="flex items-center justify-between">
            ...
            <a href="#" class="text-xs text-primary-600 dark:text-primary-400 hover:underline">Forgot password?</a>
          </div>
          <div class="relative">
      ...
      <div class="text-center text-sm text-surface-500 dark:text-surface-400">
        ...
        <NuxtLink to="/register" class="text-primary-600 dark:text-primary-400 font-semibold hover:underline">Create account</NuxtLink>
      </div>
    </div>
  </div>
</template>
