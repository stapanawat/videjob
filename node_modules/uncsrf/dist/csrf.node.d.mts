import { CipherCCMTypes, CipherOCBTypes, CipherGCMTypes } from 'node:crypto';

type EncryptAlgorithm = CipherCCMTypes | CipherOCBTypes | CipherGCMTypes | string;
type EncryptSecret = Buffer;
declare const defaultEncryptAlgorithm: EncryptAlgorithm;
declare const importEncryptSecret: (secret?: string, _encryptAlgorithm?: EncryptAlgorithm | "") => Promise<EncryptSecret>;
/**
